			...
			<footer>
				<div className={cx('container')}>
							...
							<div className={cx('col-lg-2', 'col-sm-6')}>
								<div className={cx('footer-links')}>
									...
									<ul>
										...
										<li>
											<a  href='https://careerbuilder.vn/vi/talentnetwork'>
							...
							<div className={cx('col-lg-2', 'col-sm-6')}>
								<div className={cx('footer-links')}>
									...
									<ul>
										...
										<li>
											<a  href='https://careerbuilder.vn/vi/jobseekers/contact'>
												Liên Hệ
											</a>
										</li>
									</ul>
									...
									<ul>
										<li>
											<a
												...
												href='https://careerbuilder.vn/viec-lam/Freelancer-k-vi.html'
												title='Freelancer'>
												Freelancer
											</a>
										</li>
								...
								<div className={cx('footer-app-links')}>
									...
									<div className={cx('app-links')}>
										...
										<a
											...
											{' '}
											<img className={cx('lazy-bg')} src='https://static.careerbuilder.vn/themes/careerbuilder/img/apple.png' alt='app' style={{}} />{' '}
										</a>{' '}
										<a
											...
											title='careerbuilder.vn-job-search'>
											{' '}
											<img className={cx('lazy-bg')} src='https://static.careerbuilder.vn/themes/careerbuilder/img/android.png' alt='app' style={{}} />{' '}
										</a>{' '}
									</div>
								</div>
									...
									<ul>
										...
										<li>
											<a
												...
												href='https://www.linkedin.com/company/careerbuilder-vietnam'>
												{' '}
					...
					<section className={cx('bottom-footer')}>
						...
						<div className={cx('right-bottom-footer')}>
