...
} from '~/App/providers/apis/jobPositionCategoryApi';
...
const JobPositionCategory = () => {
	...
	const { data, isFetching } = useGetAllJobPositionCategoryQuery(
		{
			params: {
				keyword,
				limit: pageSize,
	...
	const [deleteMutation] = useDeleteJobPositionCategoryMutation();
...
export default JobPositionCategory;
