...
import { useGetAllBenefitsQuery, useDeleteBenefitsMutation } from '~/App/providers/apis/benefits';
...
const Benefits = () => {
	...
	const { data, isFetching } = useGetAllBenefitsQuery(
		{
			params: {
				keyword,
				limit: pageSize,
	...
	const [deleteMutation] = useDeleteBenefitsMutation();
	...
	const columns = useMemo(
		() => [
			...
			{ Header: 'Tên Lợi Ích', accessor: 'name' },
