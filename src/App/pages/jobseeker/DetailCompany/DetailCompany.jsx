...
const DetailCompany = ({cx}) => {
  return (
    ...
    <img
    src="https://images.careerbuilder.vn/employer_folders/lot0/296390/148x148/95744logo.jpg"
    alt="Công ty TNHH Sky Pak"
    />
    </div>
    <div className={sx("content")}>
    <h1 className={sx("name")}>Công ty TNHH Sky Pak</h1>
    <strong>Địa điểm</strong>
    <p>36 đường số 31C, khu C, phường An Phú, Quận 2</p>
    <hr />
    ...
    <li>
    {" "}
    <span className={sx("mdi","mdi-gavel")} /> Loại hình hoạt động: Trách
    nhiệm hữu hạn{" "}
    </li>
    <li>
    {" "}
    ...
    <p></p>
    <p>
    Công ty TNHH SKY PAK cung cấp các giải pháp về công nghệ đóng gói và
    vận chuyển an toàn cho ngành xuất khẩu hàng đầu Việt Nam. Trách
    nhiệm của SKY PAK là đem đến cho khách hàng sự an tâm và tín nhiệm
    khi sử dụng giải pháp công nghệ đóng gói bảo vệ tinh hoa sản phẩm
    của Khách hàng.
    <br />
    <br />
    SKY PAK luôn xây dựng môi trường làm việc năng động, chuyên nghiệp
    và hiệu quả cho tất cả nhân viên với các nguyên tắc Uy tín với khách
    hàng – Tôn trọng khách hàng – Tinh thần làm việc nhóm cùng khách
    hàng – Đoàn kết cùng khách hàng.
    <br />
    <br />
    Với định hướng trở thành doanh nghiệp Việt Nam hàng đầu cung cấp
    giải pháp đóng gói và vận chuyển trong nước và quốc tế. SKY PAK đang
    cần tìm kiếm thêm thành viên để đồng hành và triển khai các chiến
    ...
    <button
    className={sx("btn-gradient")}
    onclick="return validataSearchJobEmp('vi');"
    >
    <p>Tìm Ngay</p>
    ...
    <input
    type="hidden"
    defaultValue="cong-ty-tnhh-sky-pak"
    name="emp_name"
    id="emp_name"
    />
