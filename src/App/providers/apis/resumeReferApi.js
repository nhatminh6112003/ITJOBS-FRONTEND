...
export const {useCreateResumeReferMutation, useUpdateResumeReferMutation ,useGetOneResumeReferQuery,useGetAllReferQuery,useLazyGetOneResumeReferQuery,useDeleteResumeReferMutation } = resumeReferApi;
